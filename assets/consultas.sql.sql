...
SELECT
    C.ID_CLIENTE, C.NOME AS CLIENTE, C.TELEFONE,
...
SELECT
    AT.ID_ATENDIMENTO, AT.DATA, AT.HORA, AT.STATUS,
...
SELECT
    AT.ID_ATENDIMENTO, AT.DATA, C.NOME AS CLIENTE,
...
SELECT
    PG.ID_PAGAMENTO, C.NOME AS CLIENTE, F.NOME AS FUNCIONARIO,
...
SELECT
    F.ID_FUNCIONARIO, F.NOME AS FUNCIONARIO,
...
SELECT
    FORMA_PAGAMENTO,
    COUNT(*) AS QUANTIDADE, SUM(VALOR) AS TOTAL, AVG(VALOR) AS TICKET_MEDIO
FROM PAGAMENTO
...
SELECT F.NOME, B.ESPECIALIDADE, B.STATUS
FROM BARBEIRO B
